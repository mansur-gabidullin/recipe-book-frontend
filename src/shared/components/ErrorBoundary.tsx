...
import {QueryClient, useQueryClient, useQueryErrorResetBoundary} from '@tanstack/react-query';
import {ErrorBoundary as ReactErrorBoundary, ErrorBoundaryProps, FallbackProps} from 'react-error-boundary';

import {AccessPermissionError, AuthenticationError} from "../exceptions";
import {LOGIN_PAGE_ROUTE, noop} from "../constants";
import {setAccessToken, setAuthRedirectLocation} from "../api";
...
export function ErrorFallback({error, resetErrorBoundary}: FallbackProps) {
    ...
    return isUnauthorized ? (<Navigate to={LOGIN_PAGE_ROUTE}/>) : (
        <div role="alert">
...
export type ResetErrorBoundaryHandler = (
    reset: () => void,
